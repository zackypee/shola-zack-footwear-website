    ...
    <section>
       <div className='aboutus mt-20 mx-4 lg:grid lg:grid-cols-2 gap-5'>
        <div className=''>
          ...
          <img className='mb-5' src="/public/about-us-page.jpg" alt="" />
          </div>
          {/**aboutus-content 2 */}
          <div className='mt-11'>
            <div className='flex w-50 h-45 lg:w-70 lg:h-50 gap-9 mb-10 ' >
              <img className='rounded-t-xl sm:w-50 lg:w-70' src="/public/shoe1.jpg" alt="" />
            <img className='rounded-t-xl '  src="/public/shoe2.jpg" alt="" />
            </div>
            {/**about us text */}
            <div>
