...
function LoginPage(){
    ...
    return(
       <div className='bg-white '>
         <div className='flex mt-30 gap-20 shadow-sm rounded-3xl justify-center items-center'>
            <div className='w-96 '><img className='rounded-3xl' src="/login.png" alt="" /></div>
            {/* login info */}
            <div className='flex flex-col'>
                    ...
                    <div className='flex flex-col gap-4  '>
                       ...
                       <div className='relative '>
                         ...
                         <button type='button'
                             ...
                             {showPassword ? <AiOutlineEyeInvisible className='text-gray-400' size={20} /> : <AiOutlineEye className='text-gray-400' size={20} />}
                            </button>
                       </div>
                ...
                <div>
                    <p className='text-xs text-gray-400 text-center mt-4'>Don't have an account? <span className='text-blue-600 underline'>Signup</span></p>
                </div>
