            ...
            <div className='flex flex-col'>
                ...
                <form onSubmit={async (e)=>{
                    ...
                    <div className='flex flex-col gap-4  '>
                        <input id="name" value={form.name} onChange={onChange} type="text" name="name" required autoComplete="name" placeholder='Full Name' className='placeholder-gray-500 placeholder-opacity-75 h-12 w-full max-w-[400px] bg-gray-200
                        rounded-sm px-3 py-1.5 sm:text-sm/6 outline-1 -outline-offset-1 outline-white/10
                        focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500' />
                       
                        <input id="email" value={form.email} onChange={onChange} type="email" name="email" required autoComplete="email" placeholder='Email address' className='placeholder-gray-500 placeholder-opacity-75 h-12 w-full max-w-[400px] bg-gray-200
                        rounded-sm px-3 py-1.5 sm:text-sm/6 outline-1 -outline-offset-1 outline-white/10
                        focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500' />
                         ...
                         <div className='relative '>
                          ...
                          required autoComplete="new-password" placeholder='Confirm Password' className='placeholder-gray-500 placeholder-opacity-75 h-12 w-full max-w-[400px] bg-gray-200
                          rounded-sm px-3 py-1.5 sm:text-sm/6 outline-1 -outline-offset-1 outline-white/10
                          focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500' />
                          <button type='button'
