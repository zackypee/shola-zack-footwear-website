  ...
  return (
     <section className="container mx-auto p-4 mt-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded shadow-md p-4 animate-slide-in-left">
        ...
        <div className="bg-white rounded shadow-md p-4 animate-slide-in-up">
          <img src="/public/shoe1.jpg" alt="Footwear" className="w-full h-64 object-cover mb-4" />
          <h3 className="text-lg font-bold mb-2">Footwear Name</h3>
          <p className="text-gray-600">Footwear Description</p>
        </div>
        <div className="bg-white rounded shadow-md p-4 animate-slide-in-right">
